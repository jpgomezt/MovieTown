                            ...
                            @foreach ($data['movie']->reviews as $review)
                                @if ($review->getIsVisible())
                                    <li class="list-group-item pb-3 pt-3">
                                        <h5 class="card-title">{{ __("movie.review_by") }} {{ $review->user->getName() }}</h5>
                            ...
                            <ul class="list-group list-group-horizontal justify-content-center">
                                <li class="list-group-item">
                                    <div class="form-group">
                                        ...
                                        <form method="POST" action="{{ route('cart.add') }}">
                                            ...
                                            <input class="form-control mt-2" type="text" placeholder="{{ __("movie.enter_quantity") }}"
                                                name="quantity">
                                            <input type="hidden" name="movie_id" value="{{ $data['movie']->getId() }}">
                                            <input class="btn btn-warning mt-2" type="submit" value="{{ __("movie.add_to_cart") }}">
                                        </form>
                                    </div>
                                </li>
                                    ...
                                    <li class="list-group-item">
                                        <div class="form-group">
                                            ...
                                            <form method="POST" action="{{ route('watchlist.addMovie') }}">
                                                ...
                                                <input type="hidden" name="movie_id" value="{{ $data['movie']->getId() }}">
                                                <input class="btn btn-danger mt-2" type="submit" value="{{ __("movie.add_to_watchlist") }}">
                                            </form>
                                        </div>
                                    </li>
                                @endif
                                <li class="list-group-item ">
                                    ...
                                    <form method="POST"
                                        ...
                                        @csrf
                                        <input class="btn btn-success mt-2" type="submit" value="{{ __("movie.review_button") }}">
                                    </form>
                                </li>
                            </ul>
                        @endguest
